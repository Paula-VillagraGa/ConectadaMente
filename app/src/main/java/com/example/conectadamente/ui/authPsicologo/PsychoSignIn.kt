...
@Composable
fun PsychoSignInScreen(navigateToRegisterPsycho: () -> Unit = {}, navigateToHomeScreen: () -> Unit = {}) {
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    ...
                    modifier = Modifier.clickable { navigateToRegisterPsycho() }, // Navegar a la pantalla de crear cuenta
                    style = TextStyle(
                        color = Purple40,
                        fontSize = 12.sp,
